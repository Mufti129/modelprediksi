...
if check_password():
    ...
    with sum_col1:
        ...
        if 'Mismatch_OLS' in df_filtered.columns:
            ...
            # Rincian Pola Match OLS (Prediksi ➔ Aktual)
            ...
            # Rincian Pola Mismatch OLS (Prediksi ➔ Aktual)
    ...
    with sum_col2:
        ...
        if 'Mismatch_RF' in df_filtered.columns:
            ...
            # Rincian Pola Match RF (Prediksi ➔ Aktual)
            ...
            # Rincian Pola Mismatch RF (Prediksi ➔ Aktual)
    ...
    with sum_col3:
        ...
        if 'Mismatch_GWR' in df_filtered.columns:
            ...
            # Rincian Pola Match GWR (Prediksi ➔ Aktual)
            ...
            # Rincian Pola Mismatch GWR (Prediksi ➔ Aktual)
